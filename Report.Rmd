...
### Supporting the display of evaluation results
...
In figure \ref{fig:LinearRegressionEvalPlot}
...
In \ref{tab:LinearRegressionEval}.
...
knitr::kable(get_evaluation_results('Linear Regression', lr_predictions),
             caption = '\\label{tab:LinearRegressionEval} Evaluation of Linear Regression')
```
...
knitr::kable(results, caption = '\\label{tab:Results} Results')
```
