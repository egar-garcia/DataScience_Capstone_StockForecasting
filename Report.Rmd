...
In the following code a Support-Vector Machine model is created and fitted/trained using the defined training set for evaluation purposes, then it makes the predictions for the data range given for the test set. The visualization of the prediction performance can be seen in figure \ref{fig:SVMEvalPlot} and the results of the evaluation are presented in the table \ref{tab:SVMEval}.
